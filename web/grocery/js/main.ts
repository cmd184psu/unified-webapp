...
const themes = new ThemeManager({ module: 'grocery', default: 'dark' });
themes.apply();
...
// ────────────────────────────────────────────────────────────────
// Pure helpers  (mirrored in main.test.js — keep in sync)
// ────────────────────────────────────────────────────────────────
...
// server write.
// mirrored in main.test.js :: recipeNameTaken
...
// mirrored in main.test.js :: ingredientsForRecipe
...
// mirrored in main.test.js :: isOwned
 ...
 */
// mirrored in main.test.js :: recipeSuffix
 ...
 */
// mirrored in main.test.js :: ownedTooltip
...
// mirrored in main.test.js :: displayName
...
// mirrored in main.test.js :: groupLabel
function groupLabel(group) {
  return group === 'No Group' ? 'Unallocated' : group;
}

// mirrored in main.test.js :: groupEmptyHint
 ...
 */
// mirrored in main.test.js :: tabControlVisible
...
// Render
// ────────────────────────────────────────────────────────────────
// NOT mirrored in main.test.js: touches the DOM, so it is not a pure helper.
